...
- [도메인 주도 설계 시작을 위한 모델링 과정](#domain-driven-design-starter-modelling-process)
  - [DDD 시작 모델링 프로세스를 언제 사용하나요?](#when-to-use-the-ddd-starter-modelling-process)
    ...
    - [작업의 주요 프로그램 시작 시](#kicking-off-a-major-program-of-work)
    - [새로운 학습 기회를 위한 도메인 탐색](#explore-your-domain-for-new-learning-opportunities)
    - [프로젝트 현 상태 평가](#assess-current-state-of-your-project)
    - [팀 재구성](#re-organising-teams)
    - [DDD 학습 및 실습](#practicing-or-learning-ddd)
  - [프로세스를 어떻게 적용하나요?](#how-to-adapt-the-process)
    - [협업 모델링으로 시작하기](#start-with-collaborative-modelling)
    - [IT 환경 평가부터 시작하기](#start-by-assessing-it-landscape)
    - [아키텍처와 팀 경계를 확정하기 전에 코딩 시작](#code-before-confirming-architecture-and-team-boundaries)
    - [7단계(정의)로 넘어가기 전에 2단계(발견)부터 6단계(조직)까지 반복](#repeat-steps-2-discover---6-organise-before-moving-to-7-define)
    - [컨텍스트 설계 전에 팀 구성](#organise-teams-before-designing-contexts)
    - [정의와 코딩의 혼합](#blending-definition-and-coding)
  - [프로세스](#the-process)
    - [이해](#understand)
      - [도구](#tools)
      - [참여자](#who-to-involve)
    - [발견](#discover)
      - [도구](#tools-1)
      - [참여자](#who-to-involve-1)
    - [분해](#decompose)
      - [도구](#tools-2)
      - [참여자](#who-to-involve-2)
    - [전략 수립](#strategize)
      - [도구/리소스](#toolsresources)
      - [참여자](#who-to-involve-3)
    - [연결](#connect)
      - [도구](#tools-3)
      - [참여자](#who-to-involve-4)
    - [조직](#organise)
      - [도구](#tools-4)
      - [참여자](#who-to-involve-5)
    - [정의](#define)
      - [도구](#tools-5)
      - [참여자](#who-to-involve-6)
    - [코딩](#code)
      - [도구](#tools-6)
      - [참여자](#who-to-involve-7)
    - [DDD 시작 모델링 과정과 워풀 프로세스의 연관성](#how-the-ddd-starter-modelling-process-relates-to-the-whirlpool-process)
  - [기여자](#contributors)
  - [기여 및 피드백](#contributions-and-feedback)
